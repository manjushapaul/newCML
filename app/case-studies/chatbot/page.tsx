...
export const metadata: Metadata = {
  title: 'AI Chatbot SaaS Platform Case Study | Code Meld Labs',
  description: 'Multi-tenant SaaS platform for creating custom AI chatbots with support for GPT-4, Claude, and RAG with document uploads.',
  openGraph: {
    title: 'AI Chatbot SaaS Platform Case Study | Code Meld Labs',
    description: 'Multi-tenant SaaS platform for custom AI chatbots with RAG capabilities',
...
export default function ChatbotCaseStudyPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <CaseStudyHero data={chatbotCaseStudy} />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4 text-gray-600">
                <div>
                  ...
                  <p>{chatbotCaseStudy.overview.client}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Problem</h3>
                  <p>{chatbotCaseStudy.overview.problem}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Goals</h3>
                  <ul className="space-y-2">
                    {chatbotCaseStudy.overview.goals.map((goal, index) => (
            ...
            <div className="lg:col-span-1">
              <CaseStudyMeta data={chatbotCaseStudy} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Gallery */}
      <CaseStudyGallery images={chatbotCaseStudy.gallery} />

      {/* Process & Decisions */}
      <CaseStudySection title="Process & Decisions">
        <div className="space-y-6">
          {chatbotCaseStudy.process.map((step, index) => (
            <div
              key={index}
      ...
      <CaseStudySection title="Results & Learnings" className="bg-gray-50">
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-4">{chatbotCaseStudy.results.title}</h3>
            <ul className="space-y-3">
              {chatbotCaseStudy.results.bullets.map((bullet, index) => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              {chatbotCaseStudy.results.nextSteps.map((step, index) => (
                <li key={index} className="flex items-start gap-3">
                  <span className="text-gray-400 mt-1.5">•</span>
