...
export const cryptoCaseStudy: CaseStudyData = {
  ...
  gallery: [
    {
      src: '/images/home-cy.png',
      alt: 'Crypto dashboard home page',
      caption: 'Home page with dashboard overview and main navigation',
      tag: 'Home',
    },
    {
      src: '/images/explore-cy.png',
      alt: 'Crypto explore and market view',
      caption: 'Explore cryptocurrencies and market data view',
      tag: 'Explore',
    },
    {
      src: '/images/fav-cy.png',
      alt: 'Favorite cryptocurrencies section',
      caption: 'Favorite coins section with saved cryptocurrencies',
      tag: 'Favorites',
    },
    {
      src: '/images/expense-cy.png',
      alt: 'Expense tracking and transactions',
      caption: 'Expense tracking and transaction management',
      tag: 'Expenses',
    },
    {
      src: '/images/statics-cy.png',
      alt: 'Crypto statistics and analytics',
      caption: 'Statistics and analytics dashboard with performance metrics',
      tag: 'Statistics',
    },
    {
      src: '/images/message-cy.png',
      alt: 'Messages and notifications',
      caption: 'Messages and notifications section',
      tag: 'Messages',
    },
  ],
  process: [
