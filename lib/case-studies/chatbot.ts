...
export const chatbotCaseStudy: CaseStudyData = {
  ...
  gallery: [
    {
      src: '/images/ai1.png',
      alt: 'AI Chatbot SaaS dashboard overview',
      caption: 'Main dashboard with chatbot management, analytics, and quick access to key features',
      tag: 'Dashboard',
    },
    {
      src: '/images/ai2.png',
      alt: 'AI Chatbot creation and configuration',
      caption: 'Create and configure new AI chatbots with model selection and basic settings',
      tag: 'Bot Creation',
    },
    {
      src: '/images/ai3.png',
      alt: 'AI Chatbot conversation interface',
      caption: 'Real-time chat interface for testing and interacting with AI chatbots',
      tag: 'Chat Interface',
    },
    {
      src: '/images/ai4.png',
      alt: 'Knowledge base and document management',
      caption: 'Knowledge base management with document uploads for RAG capabilities',
      tag: 'Knowledge Base',
    },
    {
      src: '/images/ai5.png',
      alt: 'AI model configuration and settings',
      caption: 'Advanced AI model configuration with GPT-4 and Claude integration options',
      tag: 'AI Configuration',
    },
    {
      src: '/images/ai6.png',
      alt: 'Conversation history and analytics',
      caption: 'Conversation history tracking with analytics and performance metrics',
      tag: 'Analytics',
    },
    {
      src: '/images/ai7.png',
      alt: 'Widget customization and embedding',
      caption: 'Widget customization panel for styling and embedding chatbots on websites',
      tag: 'Widget Setup',
    },
    {
      src: '/images/ai8.png',
      alt: 'Tenant management and settings',
      caption: 'Multi-tenant management with tenant isolation and configuration settings',
      tag: 'Tenant Management',
    },
    {
      src: '/images/ai9.png',
      alt: 'User management and permissions',
      caption: 'User management interface with role-based access control and permissions',
      tag: 'User Management',
    },
  ],
  process: [
