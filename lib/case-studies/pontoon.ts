...
export const pontoonCaseStudy: CaseStudyData = {
  ...
  gallery: [
    {
      src: '/images/P1.png',
      alt: 'Pontoon Sports interface view 1',
      caption: 'Pontoon Sports platform interface showcasing key features',
      tag: 'Interface',
    },
    {
      src: '/images/P2.png',
      alt: 'Pontoon Sports interface view 2',
      caption: 'Pontoon Sports platform interface showcasing key features',
      tag: 'Interface',
    },
    {
      src: '/images/P3.png',
      alt: 'Pontoon Sports interface view 3',
      caption: 'Pontoon Sports platform interface showcasing key features',
      tag: 'Interface',
    },
    {
      src: '/images/P4.png',
      alt: 'Pontoon Sports interface view 4',
      caption: 'Pontoon Sports platform interface showcasing key features',
      tag: 'Interface',
    },
    {
      src: '/images/P5.png',
      alt: 'Pontoon Sports interface view 5',
      caption: 'Pontoon Sports platform interface showcasing key features',
      tag: 'Interface',
    },
    {
      src: '/images/P6.png',
      alt: 'Pontoon Sports interface view 6',
      caption: 'Pontoon Sports platform interface showcasing key features',
      tag: 'Interface',
    },
  ],
