...
export const pontoonCaseStudy: CaseStudyData = {
  ...
  gallery: [
    {
      src: '/images/P1.png',
      alt: 'Pontoon Sports homepage and product showcase',
      caption: 'Homepage featuring product categories, navigation, and featured collections',
      tag: 'Homepage',
    },
    {
      src: '/images/P2.png',
      alt: 'Pontoon Sports product listing page',
      caption: 'Product listing page with filters, categories, and product grid display',
      tag: 'Product Listing',
    },
    {
      src: '/images/P3.png',
      alt: 'Pontoon Sports custom kit designer interface',
      caption: 'Custom kit designer with React-powered customization tools for team apparel',
      tag: 'Kit Designer',
    },
    {
      src: '/images/P4.png',
      alt: 'Pontoon Sports product detail page',
      caption: 'Product detail page with multiple views, customization options, and add to cart',
      tag: 'Product Details',
    },
    {
      src: '/images/P5.png',
      alt: 'Pontoon Sports shopping cart and checkout',
      caption: 'Shopping cart interface with custom design specifications and checkout process',
      tag: 'Cart & Checkout',
    },
    {
      src: '/images/P6.png',
      alt: 'Pontoon Sports order confirmation and account',
      caption: 'Order confirmation page and account management interface',
