...
export const nexspotCaseStudy: CaseStudyData = {
  ...
  gallery: [
    {
      src: '/images/home.png',
      alt: 'NexSpot home page',
      caption: 'Home page with hero section and compelling value proposition',
      tag: 'Home',
    },
    {
      src: '/images/home-workspace.png',
      alt: 'NexSpot workspace exploration across devices',
      caption: 'Responsive workspace exploration section showcasing available spaces across desktop, tablet, and mobile',
      tag: 'Workspace',
    },
    {
      src: '/images/popup.png',
      alt: 'NexSpot workspace booking modal',
      caption: 'Private cabins booking modal with detailed workspace information and booking options',
      tag: 'Booking',
    },
    {
      src: '/images/About.png',
      alt: 'NexSpot About section',
      caption: 'About section showcasing the platform features and benefits',
      tag: 'About',
    },
    {
      src: '/images/workspace.png',
      alt: 'NexSpot workspace showcase',
      caption: 'Workspace showcase section highlighting available spaces',
      tag: 'Workspace',
    },
    {
      src: '/images/contact.png',
      alt: 'NexSpot contact section',
      caption: 'Contact section for getting in touch with the team',
      tag: 'Contact',
    },
  ],
  process: [
