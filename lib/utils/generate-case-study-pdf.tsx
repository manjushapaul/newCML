...
export const CaseStudyPDF = ({ data }: CaseStudyPDFProps) => {
  // Strip HTML tags from summary for PDF (PDF renderer doesn't support HTML)
  const summaryText = stripHTML(data.hero.summary)
    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.coverPage}>
          ...
          <Text style={styles.coverSubtitle}>{summaryText}</Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        {data.results.nextSteps && data.results.nextSteps.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.subsectionTitle}>What I Would Do Next</Text>
            <View style={styles.bulletList}>
